import { gdprMenuItems, menuItems, socialItems } from "@/constants";
...
const Footer = () => {
    return (
        <footer className="overflow-hidden text-gray-400 bg-gray-900 body-font">
            <div
                className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start lg:flex-row md:flex-nowrap"
            >
                ...
                <div className="flex flex-wrap flex-grow w-full mt-10 -mb-10 text-center lg:pl-20 lg:mt-0 lg:text-left">
                    <div className="w-full px-4 lg:w-1/3 md:w-1/3">
                        ...
                        <nav className="mb-10 list-none">
                            <li className="mb-1">
                                <a href="tel:+393345832026" className="text-gray-400 book-appointment hover:text-white">Richiedi Appuntamento</a>
                            </li>
                            <li>
                                <a href="mailto:alfierigloria.osteopata@gmail.com?subject=Informazioni Visita Osteopatica" className="text-gray-400 req-more-info hover:text-white">Maggiori Informazioni</a>
                            </li>
                        </nav>
                    </div>
                    <div className="w-full px-4 lg:w-1/3 md:w-1/3">
            ...
            <div className="bg-opacity-75 bg-zinc-950/40">
                ...
                <div className="container flex justify-between py-5 mx-auto max-sm:flex-col">
                    ...
                    >
                        &copy; {currentYear} Alfieri Gloria Osteopata — Riproduzione Riservata
                    </p>

                    <SocialIcons facebook="alfierigloria.osteopata" instagram="alfierigloria.osteopata" />
